...
class AuctionHouse extends PluginBase {
	...
	private const RESOURCES = [
	    "statements/mysql.sql" => true, "statements/sqlite.sql" => true,
        "language/en_US.yml" => false, "language/ru_RU.yml" => false,
        "language/de_DE.yml" => false, "language/ko_KO.yml" => false
    ];
	...
	public function onEnable(): void {
		...
		$this->getServer()->getCommandMap()->register($this->getDescription()->getName(), new AHCommand($this, "거래소", "거래소 명령어"));
