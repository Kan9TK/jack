...
class Text{
	...
	public function spawnTo(Player $player) : void{
		...
		$pk->position = $this->pos->asVector3();
		$pk->actorRuntimeId = $pk->actorRuntimeId = $this->entityId;
        $pk->abilitiesPacket = UpdateAbilitiesPacket::create(0, 0, $this->entityId /* TODO: this should be unique ID */, []);
		$pk->username = $this->string;
		$pk->uuid = $this->uuid;
		$pk->motion = null;
        $pk->gameMode = 1;
